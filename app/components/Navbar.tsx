                        ...
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    {item.label}
                                    {showCardsBadge && (
                                        <span className="absolute -right-1 -top-2 inline-flex min-w-[20px] items-center justify-center rounded-full bg-black px-1.5 py-0.5 text-[10px] font-semibold tracking-normal text-white">
                                            {cardDueCount}
                                        </span>
                                    )}
                                    <span
